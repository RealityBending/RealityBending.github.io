 ...
 * every other way it gets opened: a project page under /<repo>/, or any other
 * copy served from a sub-path.
 *
 ...
 *
 * Without this, pressing a tab in a sub-path-mounted copy writes
...
/* The real, mounted URL a route lives at — for a control *inside* the page that
   ...
   href of `/research/creations/` is a URL outside a sub-path-mounted copy. Returns
